...
- **You have to review at least 2 other [open pull requests](https://github.com/iam-mhaseeb/awesome/pulls).** Try to prioritize unreviewed PRs, but you can also add more comments to reviewed PRs. Go through the below list when reviewing. This requirement is meant to help make the Awesome project self-sustaining. Comment here which PRs you reviewed. You're expected to put a good effort into this and to be thorough. Look at previous PR reviews for inspiration.
...
- Includes a project logo/illustration whenever possible.
	- Either fullwidth or placed at the top-right of the readme.
...
- Has [contribution guidelines](https://github.com/iam-mhaseeb/awesome/blob/master/awesome.md#include-contribution-guidelines).
